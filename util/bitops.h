...
static inline u64 rol64(u64 x, u32 n) {
  return _rotl64(x, n);
}

static inline u64 ror64(u64 x, u32 n) {
  return _rotr64(x, n);
}

// BMI/BMI2 特殊操作
#ifdef __BMI__
static inline u64 blsr64(u64 x) {
  return _blsr_u64(x);
} // 清除最低位 1
static inline u64 blsi64(u64 x) {
  return _blsi_u64(x);
} // 提取最低位 1
#endif
...
static inline u32 rol32(u32 x, u32 n) {
  return _rotl(x, n);
}

static inline u32 ror32(u32 x, u32 n) {
  return _rotr(x, n);
}
...
// ================= LSB / MSB =================
static inline u32 lsb64(u64 x) {
  return ctz64(x);
}

static inline u32 msb64(u64 x) {
  return 63 - clz64(x);
}

static inline u32 lsb32(u32 x) {
  return ctz32(x);
}

static inline u32 msb32(u32 x) {
  return 31 - clz32(x);
}
